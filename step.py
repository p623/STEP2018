...
##どうやって単語の組み合わせの中からcollocationの良いものだけを抽出すれば良い...?
##これだと二つの単語の組み合わせしかできない,(3,4つの単語の組み合わせも同じシステムに組み込みたいなあ...)
#Ans2=[]
#Ans2Point=[]

##word1 + word2 に含まれる文字が入力した文字列に全て含まれていればok
#for word1 in Ans:
    #for word2 in Ans[Ans.index(word1):]:##word1+word2とword2+word1の両方を試さなくても良いように
        #wdzpt=0
        #j=0
        #words=word1+word2
        #l2=list(words)
        ##アルファベット順に
        #l2.sort()
        ##各単語に対してポイントを計算する関数を定義しとけば以下の記述の重複はなくなる
